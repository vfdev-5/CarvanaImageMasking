...
from common.data_utils import train_ids, test_ids, get_filename
...
class CarvanaDataset(Dataset):
    ...
    def __init__(self, dataset_type, geom_transform=None, color_transform=None):
        ...
        assert dataset_type in [CarvanaDataset.TRAINVAL, CarvanaDataset.TEST], \
            "Dataset type should be CarvanaDataset.TRAINVAL or CarvanaDataset.TEST"
